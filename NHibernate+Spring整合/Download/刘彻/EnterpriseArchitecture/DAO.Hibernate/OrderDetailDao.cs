...
namespace DAO.Hibernate
{
    ...
    public partial class OrderDetailDao :IOrderDetailDao
    {
        ...
        public void Save(OrderDetail pEntity)
        {
        ...
        /// <param name="pId">主键</param>
        /// <returns></returns>
        public OrderDetail Get(int pId)
        {
        ...
        /// <param name="pId">主键</param>
        /// <returns></returns>
        public OrderDetail Load(int pId)
        {
        ...
        /// <returns></returns>
        public List< OrderDetail> GetList(List<CanYouWhere> pWhere)
        {
            int recordCount = 0;
        ...
        /// <returns></returns>
        public List< OrderDetail> GetList(string pOrderby, bool isAsc)
        {
            int recordCount = 0;
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        /// <returns></returns>
        public List< OrderDetail> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount)
        {
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        public List< OrderDetail> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount)
        {
