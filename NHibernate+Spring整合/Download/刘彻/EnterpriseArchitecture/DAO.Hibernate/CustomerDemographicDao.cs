...
namespace DAO.Hibernate
{
    ...
    /// </summary>
    public partial class CustomerDemographicDao :ICustomerDemographicDao
    {
        ...
        /// <param name="pId">主键</param>
        /// <returns></returns>
        public CustomerDemographic Get(int pId)
        {
        ...
        /// <param name="pId">主键</param>
        /// <returns></returns>
        public CustomerDemographic Load(int pId)
        {
        ...
        /// <returns></returns>
        public List< CustomerDemographic> GetList(List<CanYouWhere> pWhere)
        {
            int recordCount = 0;
        ...
        /// <returns></returns>
        public List< CustomerDemographic> GetList(string pOrderby, bool isAsc)
        {
            int recordCount = 0;
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        /// <returns></returns>
        public List< CustomerDemographic> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount)
        {
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        public List< CustomerDemographic> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount)
        {
