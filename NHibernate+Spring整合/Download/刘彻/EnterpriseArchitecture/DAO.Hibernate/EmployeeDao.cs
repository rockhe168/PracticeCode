...
namespace DAO.Hibernate
{
    ...
    public partial class EmployeeDao :IEmployeeDao
    {
        ...
        public void Save(Employee pEntity)
        {
        ...
        /// <returns></returns>
        public List< Employee> GetList(List<CanYouWhere> pWhere)
        {
            int recordCount = 0;
        ...
        /// <returns></returns>
        public List< Employee> GetList(string pOrderby, bool isAsc)
        {
            int recordCount = 0;
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        /// <returns></returns>
        public List< Employee> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount)
        {
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        public List< Employee> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount)
        {
