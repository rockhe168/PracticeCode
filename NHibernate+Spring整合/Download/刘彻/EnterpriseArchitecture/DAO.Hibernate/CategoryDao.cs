...
namespace DAO.Hibernate
{
    ...
    public partial class CategoryDao :ICategoryDao
    {
        ...
        public void Save(Category pEntity)
        {
        ...
        /// <returns></returns>
        public List< Category> GetList(List<CanYouWhere> pWhere)
        {
            int recordCount = 0;
        ...
        /// <returns></returns>
        public List< Category> GetList(string pOrderby, bool isAsc)
        {
            int recordCount = 0;
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        /// <returns></returns>
        public List< Category> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount)
        {
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        public List< Category> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount)
        {
