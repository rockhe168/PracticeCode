...
namespace DAO.Hibernate
{
    ...
    /// </summary>
    public partial class RegionDao :IRegionDao
    {
        ...
        public void Save(Region pEntity)
        {
        ...
        /// <returns></returns>
        public List< Region> GetList(List<CanYouWhere> pWhere)
        {
            int recordCount = 0;
        ...
        /// <returns></returns>
        public List< Region> GetList(string pOrderby, bool isAsc)
        {
            int recordCount = 0;
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        /// <returns></returns>
        public List< Region> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount)
        {
            List<CanYouWhere> wheres = new List<CanYouWhere>();
        ...
        public List< Region> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount)
        {
