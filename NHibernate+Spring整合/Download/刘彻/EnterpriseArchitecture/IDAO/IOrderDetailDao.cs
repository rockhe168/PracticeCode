...
namespace IDAO
{
    ...
    public partial interface IOrderDetailDao
    {
        ...
        /// <param name="pId">主键</param>
        /// <returns></returns>
        OrderDetail Get(int pId);
        /// <summary>
        /// 获取实体代理，对象拉关系使用
        /// </summary>
        /// <param name="pId">主键</param>
        /// <returns></returns>
        OrderDetail Load(int pId);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        List< OrderDetail> GetList(List<CanYouWhere> pWhere);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        ...
        /// <returns></returns>
        List< OrderDetail> GetList(string pOrderby, bool isAsc);
        /// <summary>
        /// 获取数据列表
        /// </summary>
        ...
        /// <returns></returns>
        List< OrderDetail> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        /// <param name="pPageIndex">所要获取的页数</param>
        ...
        List< OrderDetail> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount);
    }
}
