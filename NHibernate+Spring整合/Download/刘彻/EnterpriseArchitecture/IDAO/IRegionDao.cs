...
namespace IDAO
{
    ...
    /// </summary>
    public partial interface IRegionDao
    {
        /// <summary>
        /// 保存实体信息
        /// </summary>
        ...
        /// <returns></returns>
        List< Region> GetList(List<CanYouWhere> pWhere);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        ...
        /// <returns></returns>
        List< Region> GetList(string pOrderby, bool isAsc);
        /// <summary>
        /// 获取数据列表
        /// </summary>
        ...
        /// <returns></returns>
        List< Region> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        /// <param name="pPageIndex">所要获取的页数</param>
        ...
        List< Region> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount);
    }
}
