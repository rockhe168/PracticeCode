...
namespace IDAO
{
    ...
    public partial interface IOrderDao
    {
        ...
        /// <returns></returns>
        List< Order> GetList(List<CanYouWhere> pWhere);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        ...
        /// <returns></returns>
        List< Order> GetList(string pOrderby, bool isAsc);
        /// <summary>
        /// 获取数据列表
        /// </summary>
        ...
        /// <returns></returns>
        List< Order> GetList(int pPageIndex, int pPageSize, string pOrderby, bool isAsc, out int pRecordCount);
        /// <summary>
        /// 获取实体列表
        /// </summary>
        /// <param name="pPageIndex">所要获取的页数</param>
        ...
        List< Order> GetList(int pPageIndex, int pPageSize, List<CanYouWhere> pWhere, string pOrderby, bool isAsc, out int pRecordCount);
    }
}
