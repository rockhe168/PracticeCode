...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="/<%=ControllerName %>/Show.bee?id=-1" target="dialog"  mask="true" width="800" height="480" title="创建" rel="CD<%=PageId %>"><span>添加</span></a></li>
        ...
        <%
            ...
            <tr>
                    ...
                    foreach (System.Data.DataColumn column in dataTable.Columns)
				{
				 ...
				 <td>
					<a title='删除' target='ajaxTodo' href='/AuthUser/Delete.bee?id=<%=row[0].ToString() %>' class='btnDel'>删除</a>					
					<a title='编辑' target="dialog"  mask="true" width="800" height="480" rel="CD<%=PageId %>" href='/AuthUser/Show.bee?id=<%=row[0].ToString() %>' class='btnEdit'>编辑</a>
					<a title='查看权限--<%=row["UserName"] %>' target="navTab"  mask="true" rel="CD<%=PageId %>" href='/AuthUser/ShowPermission.bee?id=<%=row[0].ToString() %>' class="button" ><span>查看权限</span></a>
				</td>
			</tr>
			<%}} %>
        </tbody>
