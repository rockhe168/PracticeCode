...
namespace LinqToProc
{
    ...
    partial void DeleteOrder_Details(Order_Details instance);
		...
		public int sp_withreturnvalue([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="NChar(5)")] string customer)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), customer);
			return ((int)(result.ReturnValue));
		}
		
        //[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.sp_multriresultset")]
        //public ISingleResult<sp_multriresultsetResult> sp_multriresultset()
        //{
        //    IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
        //    return ((ISingleResult<sp_multriresultsetResult>)(result.ReturnValue));
        //}
        
        //多结果集
        [global::System.Data.Linq.Mapping.FunctionAttribute(Name = "dbo.sp_multriresultset")]
        [ResultType(typeof(Customers))]
        [ResultType(typeof(Employees))]
        public IMultipleResults sp_multriresultset()
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
	...
	public partial class sp_multriresultsetResult
	{
		...
		public sp_multriresultsetResult()
		{
		}
