<%@ Page Language="C#" MasterPageFile="~/Top_Down.master" AutoEventWireup="true" CodeFile="SearchNews.aspx.cs" Inherits="Search_SearchNews" Title="找找看-新闻" %>
                            ...
                            <div style="text-align: center">
                                <ul id="hotwordsUL" class="hotWords">
                                    <asp:Repeater ID="repeaterHotWords" runat="server">
                                        <ItemTemplate>
                                            <li><a href='SearchNews.aspx?kw=<%#Eval("KeyWord") %>'>
                                                <%#Eval("KeyWord") %>
                                            </a></li>
                                        </ItemTemplate>
                                    </asp:Repeater>
