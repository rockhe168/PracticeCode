<%@ Page Language="C#" MasterPageFile="~/Top_Down.master" AutoEventWireup="true" CodeFile="CompanyLogin.aspx.cs" Inherits="Company_CompanyLogin" Title="企业登录" %>
...
<div class="content">
    <div class="denglu">
        <div class="dl_title"><p class="hide">企业登录</p></div>
        <div class="dl_table">
            <table width="300">
                  <tr>
             ...
             <table width="308">
                  ...
                  <tr>
                       ...
                       <td class="zc_tar"><a href='<%=URLManage.GetURL("~/CompanyZone/ForgetSercret","")%>'>忘记密码？</a></td>
                       <td>&nbsp;</td>   
                  </tr>
             </table>
             <table width="250" class="tr_border">
                  <tr>
                       <td align="center">还不是企业？请点击这里<a href='<%=URLManage.GetURL("~/Company/CompanyRegister","")%>'><img src="../images/dl_zc.png" /></a></td>   
                  </tr>
             </table>
      </div>
    </div>
