...
function EmailChecking(){
 ...
 //忘记密码
      ...
      $("#img").attr("src","../Admin/FileManage/VerifyChars.ashx?date="+new Date());
		...
		if(IsCheck)
		{
		var Data={"txtUserName":$("#txtUserName").val(),"txtPwd":$("#txtPwd").val(),"txtEmail":$("#txtEmail").val(),"txtCheckCode":$("#txtCheckCode").val()};
		     $.ajax({ 
            url:"Data/GetMemberInfo.ashx?method=SaveMemberInfo", 
            type:"post", 
            data:Data, 
            success:function(ReturnData){ 
           var jsonInfo= $.parseJSON(ReturnData); 
