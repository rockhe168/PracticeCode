<%@ Page Language="C#" MasterPageFile="~/CompanyZone.master" AutoEventWireup="true" CodeFile="ProductManage.aspx.cs" Inherits="CompanyZone_ProductManage" Title="产品管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  <link href="../Admin/css/demo.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../js/AjaxJsDeal/CompanyProductMange.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="nav">
    <ul class="TabBarLevel1" id="Ul2">
            ...
            <li class="selected"><a style="color: #FFF" href='<%=URLManage.GetURL("~/CompanyZone/ProductManage","")%>'>产品管理</a></li>
            <li><a href='<%=URLManage.GetURL("~/CompanyZone/CompanyInfo","")%>'>个人简介</a></li>
            <li><a href='<%=URLManage.GetURL("~/CompanyZone/Reward","")%>'>获奖情况</a></li>
            <li  ><a  href='<%=URLManage.GetURL("~/CompanyZone/CompanyPic.aspx","")%>'>企业美景图</a></li>
        </ul>
      </div>
        ...
        url="Data/CompanyZoneInfo.ashx?method=SearchProduct"  idField="Id" multiSelect="false">
    ...
    <script type="text/javascript">
        mini.parse();
        //用于产品图片管理页面URL配置
        var ProductPicManageURL='<%=URLManage.GetURL("~/CompanyZone/ProductPicManage","")%>';
