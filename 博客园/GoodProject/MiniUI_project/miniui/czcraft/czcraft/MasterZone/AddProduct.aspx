<%@ Page Language="C#" MasterPageFile="~/Zone.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="MasterZone_AddProduct" Title="添加产品" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="nav">
        <ul class="TabBarLevel1" id="Ul1">
		   <li class="selected"><a style="color:#FFF" href='<%=URLManage.GetURL("~/MasterZone/AddProduct","")%>' >商品添加</a></li>
