...
$("body").append("<div id=\"compare\" class=\"compare\"><div class=\"mt\"><h5>ddd</h5><div class=\"extra\" onclick=\"clearCompare()\"></div></div><div class=\"comPro\"><ul class=\"mc\" id=\"comProlist\"></ul><div class=\"mb\"><input type=\"button\" value=\"ddd\" class=\"btn\" id=\"compareImg\" onclick=\"openCompare()\"></div></div></div>");
...
if(proIDs.length<3){
proIDs.push(checkid);
$("#comProlist").append("<li id='check_"+checkid+"'><a title='ddd' class='close' onclick='reduceCompare("+checkid+")'></a>"+checkProName+"</li>");
...
compareListTemp+="<li id='check_"+cootemp[i].split("||")[0]+"'><a title='ddd' class='close' onclick='reduceCompare("+cootemp[i].split("||")[0]+")'></a>"+unescape(cootemp[i].split("||")[1])+"</li>";
