      ...
      return;
          ...
          $.ajax({
            ...
            data:{"UserName":$("#txtUserName").val(),"QQ":$("#txtQQ").val(),"Email":$("#txtEmail").val(),"Nation":$("#selNational").val(),"Sex":$("#Man").val(),"Province":$("#selProvince").val(),"City":$("#selCity").val(),"Country":$("#selCountry").val(),"Address":$("#txtHomeBase").val(),"ZipCode":$("#txtZipCode").val(),"MobilePhone":$("#txtMobilePhone").val(),"TelPhone":$("#txtTelPhone").val()},
            type:"post",
      ...
      function GetUserInfo(){
        $.ajax({
            url:"Data/GetMemberInfo.ashx?method=GetUserInfo",
            type:"post",
            success:function(text){
                var DataJson=$.parseJSON(text);
                if(DataJson.Status){
    ...
    //     $("#selCity").append("<option value='-1'>请选择</option>");
     ...
     function GetArea(CodeId,e,InitData){
            $.ajax({
            url:"Data/GetMemberInfo.ashx?method=GetArea&CodeId="+CodeId,
            type:"post",
            success:function(text){
                var DataJson=$.parseJSON(text);
                var item='';
