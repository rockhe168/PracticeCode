<%@ Page Language="C#" MasterPageFile="~/Zone.master" AutoEventWireup="true" CodeFile="Reward.aspx.cs" Inherits="MasterZone_Reward" Title="获奖情况" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  <link href="../Admin/css/demo.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../js/AjaxJsDeal/MasterReward.js" type="text/javascript"></script>
     ...
     <div class="nav">
        <ul class="TabBarLevel1" id="Ul1">
           ...
           <li  ><a   href='<%=URLManage.GetURL("~/MasterZone/MasterInfo","")%>'>个人简介</a></li>
		 	  <li  class="selected"><a  style="color:#FFF"  href='<%=URLManage.GetURL("~/MasterZone/Reward","")%>'>获奖情况</a></li>
         
	    </ul>
    </div>

  <div id="datagrid1" class="mini-datagrid" style="width:100%"
        url="Data/MasterZoneInfo.ashx?method=SearchMasterRewardPic"  idField="id"
