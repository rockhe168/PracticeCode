<%@ Page Language="C#" MasterPageFile="~/CompanyZone.master" AutoEventWireup="true" CodeFile="CompanyPic.aspx.cs" Inherits="CompanyZone_CompanyPic" Title="企业美景图" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <meta http-equiv="content-type" content="text/html; charset=UTF-8" />
  ...
  <link href="../Admin/css/demo.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../js/AjaxJsDeal/CompanyPic.js" type="text/javascript"></script>
 ...
 <div class="nav">
    <ul class="TabBarLevel1" id="Ul2">
            ...
            <li><a href='<%=URLManage.GetURL("~/CompanyZone/Reward","")%>'>获奖情况</a></li>
             <li class="selected" ><a style="color:#FFF" href='<%=URLManage.GetURL("~/CompanyZone/CompanyPic","")%>'>企业美景图</a></li>
        </ul>
      
    </div>

  <div id="datagrid1" class="mini-datagrid" style="width:100%"
        url="Data/CompanyZoneInfo.ashx?method=SearchCompanyPic"  idField="Id"
