<%@ Page Language="C#" MasterPageFile="~/CompanyZone.master" AutoEventWireup="true" CodeFile="ProductPicManage.aspx.cs" Inherits="CompanyZone_ProductPicManage" Title="产品图片管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  <script src="../Admin/scripts/jquery.MetaData.js" type="text/javascript"></script>
    ...
    <script src="../js/AjaxJsDeal/CompanyProductPicManage.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="nav">
    ...
    <div class="nm_table">
        ...
        url="Data/CompanyZoneInfo.ashx?method=SearchProductPic"  idField="Id"
    ...
    $(function(){
     ...
     //图片重绘
        function onReaderPic(e){
          return '<img src="../Admin/FileManage/GetImg.ashx?method=GetMainProductPic&type=small&fileName='+e.value+'" style="width:60px;height:40px;"/>';
