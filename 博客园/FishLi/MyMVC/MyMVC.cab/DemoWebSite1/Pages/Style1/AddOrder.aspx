...
<%= HtmlExtension.RefJsFileHtml("/js/MyPage/AddOrder.js")%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<form id="formAddOrder" action="" method="post">
<table cellpadding="4" cellspacing="0" class="GridView2" style="width: 99%">
<tr class="GridView_HeaderStyle"><td colspan="2"><b>新增订单</b></td></tr>
<tr><td style="width: 100px">订单日期</td><td>
	<input type="text" id="txtOrderDate" name="OrderDate" readonly="readonly" 
		class="myTextboxReadonly" value='<%= DateTime.Now.ToString("yyyy-MM-dd") %>' /></td></tr>
...
<tr><td class="vertical">备注</td><td>
	<textarea id="txtComment" name="Comment" class="myTextbox" 
			style="width: 650px; height: 70px" cols="50"></textarea></td></tr>

<tr><td style="height: 35px"></td><td></td></tr>
	
<tr><td></td><td>
	<a id="btnSubmit" href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-ok">确定保存此订单记录　并继续新增</a>
	<span style="padding-left: 25px"></span>
	<a href="javascript:window.location = window.location;" id="anchorCancel" 
			class="easyui-linkbutton" iconCls="icon-remove">放弃当前输入内容，我要新增记录</a>
	</td></tr>
</table>
