    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnAdd").click(function () {
                $.get("./Ajax/PaymentInfoHandler.ashx?action=AddPaymentInfo&ip=111111&mac=3333333", function (data) {
                    $("#msg").html(data);
                });
            });
            ...
            $("#btnAddChannel").click(function () {
                $.get("./Ajax/ChannelHandler.ashx?action=AddChannelHistory&channelNo=111111&url=baidu.com", function (data) {
                    $("#msg").html(data);
                });
            });
