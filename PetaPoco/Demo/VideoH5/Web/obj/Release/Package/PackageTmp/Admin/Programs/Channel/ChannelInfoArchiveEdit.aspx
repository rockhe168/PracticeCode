<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChannelInfoArchiveEdit.aspx.cs" Inherits="Web.Admin.Programs.Channel.ChannelInfoArchiveEdit" %>
<div class="pageContent">
    <form method="post" action="Ajax/ChannelHandler.ashx?action=SaveInputMoney" class="pageForm"
    ...
    <div class="pageFormContent" layouth="58">
        ...
        <div class="unit">
            <label>
                录入安装量：</label>
            <input type="text" name="inputcount" size="30" value='<%=this.DefaultObject.inputcount %>'class="required digits" />
        </div>
        <div class="unit">
            <label>
                录入佣金：</label>
