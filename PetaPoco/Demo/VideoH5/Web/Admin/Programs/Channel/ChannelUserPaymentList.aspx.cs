...
{
    public partial class ChannelUserPaymentList : BasePager<paymentinfo>
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                sql.Append("WHERE channelNo = @0 and ptype=2 and isdisplay=true", UserInfo.channelNo);
                ...
                PageData = videoContext.paymentinfo.Page(
