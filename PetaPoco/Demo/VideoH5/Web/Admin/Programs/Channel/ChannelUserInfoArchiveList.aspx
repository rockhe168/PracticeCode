<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChannelUserInfoArchiveList.aspx.cs" Inherits="Web.Admin.Programs.Channel.ChannelUserInfoArchiveList" %>
<%@ Import Namespace="videoContext" %>

<form id="pagerForm" method="post" action="Programs/Channel/ChannelUserInfoArchiveList.aspx">
<input type="hidden" name="pageNum" value="1" />
<input type="hidden" name="numPerPage" value="<%=DefaultListPagination.PageSize %>" />
</form>
<div class="pageHeader">
    <form id="pageHeader" onsubmit="return navTabSearch(this);" action="Programs/Channel/ChannelUserInfoArchiveList.aspx"
    method="post">
    <div class="searchBar">
